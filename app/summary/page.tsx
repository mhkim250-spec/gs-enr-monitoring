...
export default function SummaryPage() {
  ...
  useEffect(()=>{if(liveNews.length<2)return;const timer=setInterval(()=>setLiveNewsIndex(index=>(index+1)%liveNews.length),4500);return()=>clearInterval(timer);},[liveNews.length]);
